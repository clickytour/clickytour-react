...
const subtitle = "A clear, practical overview for faq pricing on ClickyTour.";
const overview = [
  "This page helps service providers understand how to use ClickyTour for faq pricing.",
    ...
    <PageShell>
      <section className="bg-gradient-to-r from-[#0F2B46] to-[#164E73] text-white py-14 md:py-16">
        <div className="container">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold mt-2">FAQ Pricing</h1>
