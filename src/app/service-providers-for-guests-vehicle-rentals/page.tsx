...
const subtitle = "From cars to boats, ClickyTour connects your rental service with tourists, property managers, and agents.";
const overview = [
  "From cars to boats, ClickyTour connects your rental service with tourists, property managers, and agents.",
  "Select the vehicle type you provide to reach the right customers.",
  "Vehicle Rentals on ClickyTou",
  "Why Choose ClickyTour for Your Rental Service?"
];
const features = [
  "Car Rentals",
  ...
  "Bicycle Rentals",
  "ATV & Buggy Rentals",
  "Boat Rentals (Motor & Sailing)",
  "Luxury Vehicle Rentals (VIP Cars, Limousines)",
  "Specialty Transport (Campervans, Off-road Vehicles)",
  "Vehicle Rentals on ClickyTou"
];
const ctas = [
  "List My Service"
    ...
    <PageShell>
      <section className="bg-gradient-to-r from-[#0F2B46] to-[#164E73] text-white py-14 md:py-16">
        <div className="container">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold mt-2">Vehicle Rentals</h1>
