...
export default function Page() {
  return (
    <PageShell>
      <Hero title="Search Vacation Rentals" subtitle="Find and filter properties by destination, dates, and features." ctaA="Get Started" ctaB="Learn More" diagram={<VacationRentalsDiagram />} />
