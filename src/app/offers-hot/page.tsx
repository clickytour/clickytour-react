...
export default function Page() {
  return (
    <PageShell>
      <Hero diagram={<OffersHotDiagram />} title="Hot Offers" subtitle="Most popular deals right now." ctaA="Get Started" ctaB="Learn More" />
      <section className="section"><div className="container">
        <SectionTitle title="Hot Offers" subtitle="Most popular deals right now." />
