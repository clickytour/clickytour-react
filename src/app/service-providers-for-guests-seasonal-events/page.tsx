...
const subtitle = "From summer festivals to winter markets, ClickyTour helps seasonal events reach the right audience at the right time.";
const overview = [
  "From summer festivals to winter markets, ClickyTour helps seasonal events reach the right audience at the right time.",
  "Select your event type for accurate promotion.",
  "Seasonal Events on ClickyTour",
  "Why Choose ClickyTour for Your Seasonal Event?"
];
const features = [
  "Summer Festivals",
  "Holiday & Christmas Markets",
  "Carnival & Parade Events",
  "Seasonal Concerts",
  "Food & Wine Festivals",
  "Cultural Heritage Days",
  "New Year & Special Holiday Events",
  "Seasonal Events on ClickyTour"
];
const ctas = [
  "List My Service"
    ...
    <PageShell>
      <section className="bg-gradient-to-r from-[#0F2B46] to-[#164E73] text-white py-14 md:py-16">
        <div className="container">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold mt-2">Seasonal Events</h1>
