...
export default function Page() {
  return (
    <PageShell>
      <Hero title="Buy Property" subtitle="Find your dream property — villas, apartments, land." ctaA="Get Started" ctaB="Learn More" diagram={<RealEstateHubDiagram />} />
      <section className="section"><div className="container">
        <SectionTitle title="Buy Property" subtitle="Find your dream property — villas, apartments, land." />
