...
export default function Page() {
  ...
  return (
    <PageShell>
      <Hero diagram={<RealEstateBuyDiagram />} title="Real Estate — Buy" subtitle="Explore properties for sale across Greece. Investment opportunities with strong ROI." ctaA="Search Properties" ctaB="Learn More" />
