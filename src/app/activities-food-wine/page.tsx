...
export default function Page() {
  return (
    <PageShell>
      <Hero diagram={<ActivitiesSearchDiagram />} title="Food & Wine Experiences" subtitle="Tastings, cooking classes, wine tours, and local cuisine." ctaA="Get Started" ctaB="Learn More" />
