...
export default function Page() {
  return (
    <PageShell>
      <Hero title="Offers & Deals" subtitle="Special prices, packages, and seasonal promotions." ctaA="Get Started" ctaB="Learn More" ctaHrefA="/search" ctaHrefB="/guests" diagram={<OffersDiagram />} />
