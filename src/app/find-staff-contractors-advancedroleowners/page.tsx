...
export default function Page() {
  return (
    <PageShell>
      <Hero diagram={<FindStaffAdvancedDiagram />} title="Advanced Staff Request" subtitle="Detailed staff request with full specifications as property owner." ctaA="Submit" ctaB="Quick Form" />
