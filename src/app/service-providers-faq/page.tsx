...
const pageTitle = "Business FAQ";

const pageHtml = `<p>Business FAQ content is coming soon. We are preparing practical guidance, clear next steps, and platform-specific details to help service providers grow on ClickyTour.</p><p>Please check back shortly for the full page content.</p>`;
