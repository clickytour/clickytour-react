...
const slug = 'owners-real-estate-request-proposals';
const fallbackTitle = 'Request Property Proposals';

export default async function OwnersRealEstateRequestProposalsPage() {
