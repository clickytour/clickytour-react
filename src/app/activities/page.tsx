...
export default function Page() {
  return (
    <PageShell>
      <Hero title="All Activities" subtitle="Browse all available activities and experiences." ctaA="Get Started" ctaB="Learn More" ctaHrefA="/tours-activities" ctaHrefB="/guests" diagram={<ToursActivitiesDiagram />} />
