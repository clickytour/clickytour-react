...
export default function Page() {
  return (
    <PageShell>
      <Hero title="Personalized Vacation Planning" subtitle="Get a custom trip plan tailored to your preferences." ctaA="Get Started" ctaB="Learn More" diagram={<VacationAssistDiagram />} />
