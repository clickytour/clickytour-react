...
export default function Page() {
  return (
    <PageShell>
      <Hero title="Advanced Search & Booking" subtitle="Find exactly what you need with advanced filters." ctaA="Get Started" ctaB="Learn More" diagram={<AdvancedSearchDiagram />} />
