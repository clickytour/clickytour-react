      ...
      <section className="section"><div className="container">
        <div className="card p-6 mb-6">
          <div className="grid md:grid-cols-4 gap-4">
            ...
            <PlaceAutocomplete label="Location" name="location" placeholder="Region / City" />
            ...
            <div className="flex items-end"><a href="/find-staff-contractors-quick-request" className="w-full px-6 py-3 bg-teal-600 text-white font-semibold rounded-xl hover:bg-teal-700 text-center block">Search</a></div>
          </div>
        </div>
