...
import { SPPromotionToolsDiagram } from '@/components/diagrams';


const subtitle = "A clear, practical overview for promotion tools on ClickyTour.";
const overview = [
  "This page helps service providers understand how to use ClickyTour for promotion tools.",
      ...
      <section className="bg-gradient-to-r from-[#0F2B46] to-[#164E73] text-white py-14 md:py-16">
        <div className="container">
          ...
          <p className="text-cyan-100 mt-4 max-w-3xl">{subtitle}</p>
            ...
            <div className="hidden lg:block max-w-sm"><SPPromotionToolsDiagram /></div>
          </div>
        </div>
      </section>
