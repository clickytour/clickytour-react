...
const overview = [
  "Join ClickyTour and make your service visible to tourists, property owners, and agents — in just a few steps.",
  "Need help completing your listing? Our support team can guide you step-by-step.",
  "Your Service in Front of Thousands of Customers",
  "ClickyTour for Service Providers"
];
const features = [
  "Business name & contact details",
  "Service description (basic text)",
  "Prices or packages",
    ...
    <PageShell>
      <section className="bg-gradient-to-r from-[#0F2B46] to-[#164E73] text-white py-14 md:py-16">
        <div className="container">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold mt-2">List Your Business/Service</h1>
