...
const subtitle = "From hiking tours to water sports, ClickyTour connects your outdoor activities with tourists looking for adventure.";
const overview = [
  "From hiking tours to water sports, ClickyTour connects your outdoor activities with tourists looking for adventure.",
  "Select the exact activity you provide to appear in targeted searches.",
  "Outdoor Activities on ClickyTour"
];
const features = [
    ...
    <PageShell>
      <section className="bg-gradient-to-r from-[#0F2B46] to-[#164E73] text-white py-14 md:py-16">
        <div className="container">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold mt-2">Outdoor Activities</h1>
