...
const subtitle = "From environmental projects to community outreach, ClickyTour connects your volunteer program with people who want to make a difference.";
const overview = [
  "From environmental projects to community outreach, ClickyTour connects your volunteer program with people who want to make a difference.",
  "Choose the program type that matches your project.",
  "Volunteer Opportunities on ClickyTour",
  "Why Choose ClickyTour for Your Volunteer Project?"
];
const features = [
  "Environmental Conservation Projects",
  "Wildlife Protection Programs",
  "Community Development & Teaching",
  "Cultural Exchange Programs",
  "Agricultural & Eco-Farming",
  "Humanitarian Aid Projects",
  "Health & Wellness Volunteer Programs",
  "Volunteer Opportunities on ClickyTour"
];
const ctas = [
  "List My Service"
    ...
    <PageShell>
      <section className="bg-gradient-to-r from-[#0F2B46] to-[#164E73] text-white py-14 md:py-16">
        <div className="container">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold mt-2">Volunteer</h1>
