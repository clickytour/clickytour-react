...
export default function Page() {
  return (
    <PageShell>
      <Hero diagram={<PortfolioDiagram/>} title="Portfolio" subtitle="Showcase of ClickyTour properties and services." ctaA="Get Started" ctaB="Learn More" ctaHrefA="/pmc-apply" ctaHrefB="/pm-companies" />
