...
const subtitle = "From walking tours to local crafts, ClickyTour helps tourists discover authentic experiences in your area.";
const overview = [
  "From walking tours to local crafts, ClickyTour helps tourists discover authentic experiences in your area.",
  "Select your exact activity for better placement in search results.",
  "Local Activities on ClickyTour",
  "Why Choose ClickyTour for Your Local Experience?"
];
const features = [
  "Walking Tours",
  "Local Market Visits",
  ...
  "Craft & Handicraft Workshops",
  "Local Storytelling Sessions",
  "Village or Neighborhood Tours",
  "Local Activities on ClickyTour"
];
const ctas = [
  "List My Service"
    ...
    <PageShell>
      <section className="bg-gradient-to-r from-[#0F2B46] to-[#164E73] text-white py-14 md:py-16">
        <div className="container">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold mt-2">Local Activities</h1>
