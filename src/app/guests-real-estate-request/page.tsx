      ...
      <section className="section"><div className="container"><div className="card p-6 md:p-8">
        ...
        <MultiStepForm steps={steps} currentStep={step} onNext={() => setStep(s => s + 1)} onPrev={() => setStep(s => s - 1)} onSubmit={() => alert('Thank you! This form is in demo mode.')}>
          {step === 0 && <div className="space-y-4">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <NumberInput label="Min sqm" name="sqmMin" />
              <NumberInput label="Max sqm" name="sqmMax" />
            </div>
          ...
          {step === 1 && <div className="space-y-4">
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div />
              <NumberInput label="Budget From (€)" name="budgetFrom" />
              <NumberInput label="Budget To (€)" name="budgetTo" />
            </div>
            <label className="flex items-center gap-2 text-sm"><input type="checkbox" className="rounded" /> Need legal/mortgage support</label>
            <TextAreaField label="Notes" name="notes" placeholder="Additional details..." />
          </div>}
          {step === 2 && <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="md:col-span-2 space-y-2">
              ...
              <label className="flex items-center gap-2 text-sm"><input type="checkbox" className="rounded" /> Send me property updates and tips.</label>
            </div>
          </div>}
        </MultiStepForm>
      </div></div></section>
