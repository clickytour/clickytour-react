...
import { SPSaleRentDiagram } from '@/components/diagrams';


const subtitle = "Whether you want to sell or rent your business, ClickyTour connects you with qualified buyers and investors.";
const overview = [
  "Whether you want to sell or rent your business, ClickyTour connects you with qualified buyers and investors.",
  "Access to Buyers & Investors : Wide network in tourism and property sectors",
  "Visibility : Business showcased in marketplace with premium reach",
  "Turn Your Service Business Into a Profitable Opportunity"
];
const features = [
  "Turn Your Service Business Into a Profitable Opportunity",
  "Why Service Providers Choose ClickyTour",
  "Why Property Managers Love ClickyTour",
  "Evaluation Form",
  "Success Story",
  "Submit Your Business for Free Evaluation",
  "Submit your business details (evaluation form)",
  "Receive valuation and listing recommendations"
];
const ctas = [
    ...
    <PageShell>
      <section className="bg-gradient-to-r from-[#0F2B46] to-[#164E73] text-white py-14 md:py-16">
        <div className="container">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold mt-2">Sale or Rent Your Business</h1>
          <p className="text-cyan-100 mt-4 max-w-3xl">{subtitle}</p>
        </div>
            <div className="hidden lg:block max-w-sm"><SPSaleRentDiagram /></div>
          </div>
        </div>
      </section>
