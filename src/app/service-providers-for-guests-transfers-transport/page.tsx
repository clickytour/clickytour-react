...
const subtitle = "From airport shuttles to VIP transfers, ClickyTour connects your transport service with customers who need reliable travel.";
const overview = [
  "From airport shuttles to VIP transfers, ClickyTour connects your transport service with customers who need reliable travel.",
  "Choose the exact service type you provide to appear in targeted searches.",
  "Transfers & Transport on ClickyTour",
  "Why Choose ClickyTour for Your Transport Business?"
];
const features = [
  "Airport Transfers",
  "Shuttle Bus Services",
  "Private Car Transfers",
  "VIP/Luxury Transfers (Chauffeur Services)",
  "Group Transport (Minibuses, Coaches)",
  "Port Transfers (Ferries, Yachts)",
  "On-demand Local Transport",
  "Transfers & Transport on ClickyTour"
];
const ctas = [
  "List My Service"
    ...
    <PageShell>
      <section className="bg-gradient-to-r from-[#0F2B46] to-[#164E73] text-white py-14 md:py-16">
        <div className="container">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold mt-2">Transfers & Transport</h1>
