...
const subtitle = "ClickyTour puts your service in front of the right audience. Start listing now and promote your business.";
const overview = [
  "ClickyTour puts your service in front of the right audience. Start listing now and promote your business.",
  "Create your free listing and start getting bookings and visibility.",
  "Monetize your service business by selling or renting it via ClickyTour marketplace.",
  "Get Discovered by Thousands of Guests, Agents, and Property Owners"
];
const features = [
  "Get Discovered by Thousands of Guests, Agents, and Property Owners",
  "How to Start",
  "ClickyTour for Service Providers",
  "Promote Your Service",
  "Ready to Promote Your Service?",
  "Latest Article & News",
  "Create your ClickyTour account",
  "Add your business details, pricing, and photos"
];
const ctas = [
  "List My Service",
  "Check Visibility"
    ...
    <PageShell>
      <section className="bg-gradient-to-r from-[#0F2B46] to-[#164E73] text-white py-14 md:py-16">
        <div className="container">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold mt-2">List & Promote</h1>
          <p className="text-cyan-100 mt-4 max-w-3xl">{subtitle}</p>
        </div>
            <div className="hidden lg:block max-w-sm"><SPListPromoteDiagram /></div>
          </div>
        </div>
      </section>
