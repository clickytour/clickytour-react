...
const subtitle = "From urgent repairs to full installations, ClickyTour connects your technical service with property owners and managers.";
const overview = [
  "From urgent repairs to full installations, ClickyTour connects your technical service with property owners and managers.",
  "Choose the specific service you provide for better targeting.",
  "Plumbing & Electrical Services on ClickyTour",
  "Why Choose ClickyTour for Your Technical Services?"
];
const features = [
  "Plumbing Repairs & Installations",
  "Electrical Repairs & Installations",
  "Emergency Call-Out Services",
  "Wiring & Rewiring Projects",
  "Appliance Installation (Water Heaters, Kitchen Equipment)",
    ...
    <PageShell>
      <section className="bg-gradient-to-r from-[#0F2B46] to-[#164E73] text-white py-14 md:py-16">
        <div className="container">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold mt-2">Plumbing & Electrical</h1>
