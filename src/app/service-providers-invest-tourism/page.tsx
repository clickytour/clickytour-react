...
import { SPInvestTourismDiagram } from '@/components/diagrams';


const subtitle = "A clear, practical overview for invest tourism on ClickyTour.";
const overview = [
  "This page helps service providers understand how to use ClickyTour for invest tourism.",
    ...
    <PageShell>
      <section className="bg-gradient-to-r from-[#0F2B46] to-[#164E73] text-white py-14 md:py-16">
        <div className="container">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold mt-2">Invest Tourism</h1>
          <p className="text-cyan-100 mt-4 max-w-3xl">{subtitle}</p>
        </div>
            <div className="hidden lg:block max-w-sm"><SPInvestTourismDiagram /></div>
          </div>
        </div>
      </section>
