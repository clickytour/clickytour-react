...
const subtitle = "From hotel linen supply to guest laundry pick-up, ClickyTour connects your service with businesses and travelers.";
const overview = [
  "From hotel linen supply to guest laundry pick-up, ClickyTour connects your service with businesses and travelers.",
  "Select the exact service you provide for targeted visibility.",
  "Laundry & Linen Services on ClickyTour",
  "Why Choose ClickyTour for Your Laundry Business?"
];
const features = [
    ...
    <PageShell>
      <section className="bg-gradient-to-r from-[#0F2B46] to-[#164E73] text-white py-14 md:py-16">
        <div className="container">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold mt-2">Laundry & Linen</h1>
