...
const subtitle = "Showcase your cultural experiences to a global audience — from live music to traditional performances.";
const overview = [
  "Showcase your cultural experiences to a global audience — from live music to traditional performances.",
  "Cultural Performances on ClickyTour",
  "Why Choose ClickyTour for Your Cultural Event?"
];
const features = [
...
const ctas = [
  "List My Service",
  "Add your details, dates, and pricing"
];
    ...
    <PageShell>
      <section className="bg-gradient-to-r from-[#0F2B46] to-[#164E73] text-white py-14 md:py-16">
        <div className="container">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold mt-2">Cultural Performances</h1>
