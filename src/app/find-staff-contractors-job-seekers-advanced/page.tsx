...
export default function Page() {
  return (
    <PageShell>
      <Hero diagram={<FindStaffAdvancedDiagram />} title="Advanced Job Application" subtitle="Apply to a specific request with full details." ctaA="Submit" ctaB="Learn More" />
