...
const subtitle = "From fine dining to local bars, ClickyTour connects your hospitality service with tourists, locals, and agents ready to book.";
const overview = [
  "From fine dining to local bars, ClickyTour connects your hospitality service with tourists, locals, and agents ready to book.",
  "Select “Dining, Cafes & Nightlife” as your category",
  "Add your service details, photos, and pricing",
  "Dining, Cafes & Nightlife on ClickyTour"
];
const features = [
  "Dining, Cafes & Nightlife on ClickyTour",
  "How to Join This Category",
  "Why Choose ClickyTour for Your Hospitality Business?",
  "Popular Services in Dining, Cafes & Nightlife",
  "Ready to List Your Dining or Nightlife Service?",
  "Step 1",
  "Step 2",
  "Step 3"
];
    ...
    <PageShell>
      <section className="bg-gradient-to-r from-[#0F2B46] to-[#164E73] text-white py-14 md:py-16">
        <div className="container">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold mt-2">Dining, Cafes & Nightlife</h1>
