...
const subtitle = "From amusement parks to educational centers, ClickyTour helps your attraction get discovered by families and tourists.";
const overview = [
  "From amusement parks to educational centers, ClickyTour helps your attraction get discovered by families and tourists.",
  "Choose the service type that best matches your listing.",
  "Attractions & Family Activities on ClickyTour",
  "Why Choose ClickyTour for Your Attraction or Family Activity?"
];
const features = [
  "Amusement Parks",
  "Water Parks",
  ...
  "Family Workshops (Cooking, Crafts, etc.)",
  "Cultural Heritage Sites",
  "Attractions & Family Activities on ClickyTour"
];
const ctas = [
  "List My Service",
  "Publish and start receiving bookings"
];
    ...
    <PageShell>
      <section className="bg-gradient-to-r from-[#0F2B46] to-[#164E73] text-white py-14 md:py-16">
        <div className="container">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold mt-2">Attractions & Family Activities</h1>
