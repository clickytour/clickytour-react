...
const slug = 'owners-real-estate-list-property';
const fallbackTitle = 'List Real Estate Property';

export default async function OwnersRealEstateListPropertyPage() {
