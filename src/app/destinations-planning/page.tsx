...
export default function Page() {
  return (
    <PageShell>
      <Hero title="Destination Planning" subtitle="Plan your trip with local insights and recommendations." ctaA="Get Started" ctaB="Learn More" diagram={<DestinationsDiagram />} />
