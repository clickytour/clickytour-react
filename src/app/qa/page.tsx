...
const sections: Array<{ label: string; icon: string; routes: string[] }> = [
  ...
  { label: 'Tools Hub & Interactive (15 active)', icon: '🛠', routes: [
    'tools',
    'tools/trip-cost-calculator',
    'tools/investment-analyzer',
    'tools/commission-calculator',
    'tools/rental-income-estimator',
    'tools/golden-visa-calculator',
    'tools/ferry-island-planner',
    'tools/property-valuation',
    'tools/occupancy-heatmap',
    'tools/guest-guidebook',
    'tools/review-response-generator',
    'tools/contract-generator',
    'tools/expense-tracker',
    'tools/itinerary-builder',
    'tools/property-comparison',
    'tools/events-calendar',
  ]},
  { label: 'Tools (Coming Soon, 16)', icon: '🔮', routes: [
    'tools/ai-description-assistant',
    'tools/custom-quote-generator',
    'tools/photo-optimizer',
    'tools/auto-video-generator',
    'tools/whatsapp-share-tool',
    'tools/client-proposal-builder',
    'tools/lead-form-generator',
    'tools/review-management-dashboard',
    'tools/bulk-listing-importer',
    'tools/service-bundler',
    'tools/agent-quotation-builder',
    'tools/no-logo-presentation',
    'tools/performance-dashboard',
    'tools/white-label-microsite',
    'tools/instant-booking-payment-link',
    'tools/social-media-post-generator',
    'tools/click-to-quote-link',
    'tools/multilingual-flyer-generator',
    'tools/visibility-boost',
  ]},
  { label: 'Role Tool Hubs', icon: '🔧', routes: [
    'agent-tools-hub',
    'agents-tools',
