...
const subtitle = "From appliance repairs to equipment servicing, ClickyTour connects your technical expertise with property owners and managers.";
const overview = [
  "From appliance repairs to equipment servicing, ClickyTour connects your technical expertise with property owners and managers.",
  "Select the exact service type for better targeting.",
  "Technical Repair Services on ClickyTour",
  "Why Choose ClickyTour for Your Technical Expertise?"
];
const features = [
  "Appliance Repairs (Kitchen, Laundry, HVAC)",
  "Pool Equipment Repairs",
  "Elevator & Lift Maintenance",
  "Mechanical Systems Servicing",
  "Preventative Technical Inspections",
    ...
    <PageShell>
      <section className="bg-gradient-to-r from-[#0F2B46] to-[#164E73] text-white py-14 md:py-16">
        <div className="container">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold mt-2">Technical Repairs</h1>
