...
const subtitle = "From VIP guest support to full-scale event management, ClickyTour connects your service with the right clients";
const overview = [
  "From VIP guest support to full-scale event management, ClickyTour connects your service with the right clients",
  "Select the exact service you offer when creating your listing.",
  "Concierge & Event Services on ClickyTour",
  "Why Choose ClickyTour for Your Concierge or Event Business?"
];
const features = [
  ...
  "VIP Guest Services",
  "Yacht & Luxury Travel Arrangements",
    ...
    <PageShell>
      <section className="bg-gradient-to-r from-[#0F2B46] to-[#164E73] text-white py-14 md:py-16">
        <div className="container">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold mt-2">Concierge & Event Services</h1>
