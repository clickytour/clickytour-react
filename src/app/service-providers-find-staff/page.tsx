...
const overview = [
  "From seasonal employees to event crew and skilled contractors, ClickyTour connects your service business with trusted professionals.",
  "Get the Staff Your Business Needs — When You Need Them",
  "Why Choose ClickyTour for Staffing?"
];
const features = [
  "Access to a pool of pre-screened professionals",
  "Seasonal, part-time, and on-demand hiring options",
  "Fast response for urgent staffing needs",
  "Local contractors familiar with tourism industry standards",
  "Get the Staff Your Business Needs — When You Need Them",
  "Why Choose ClickyTour for Staffing?",
  "Staffing Categories for Service Providers",
  "Click to Get the Staff You Need"
];
const ctas = [
  "Request Staff Now",
  "Click 1: Select the staff category"
];
