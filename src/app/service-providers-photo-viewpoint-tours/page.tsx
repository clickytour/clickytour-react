...
const subtitle = "A clear, practical overview for photo viewpoint tours on ClickyTour.";
const overview = [
  "This page helps service providers understand how to use ClickyTour for photo viewpoint tours.",
    ...
    <PageShell>
      <section className="bg-gradient-to-r from-[#0F2B46] to-[#164E73] text-white py-14 md:py-16">
        <div className="container">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold mt-2">Photo Viewpoint Tours</h1>
