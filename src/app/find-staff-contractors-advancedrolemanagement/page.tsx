...
export default function Page() {
  return (
    <PageShell>
      <Hero diagram={<FindStaffAdvancedDiagram />} title="Advanced Staff Request" subtitle="Detailed staff request with full specifications as pm companies." ctaA="Submit" ctaB="Quick Form" />
      <section className="section"><div className="container"><div className="card p-6 md:p-8">
        ...
        <form className="space-y-4" onSubmit={e => { e.preventDefault(); alert('Thank you! This form is in demo mode.'); }}>
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <TextInput label="Properties Covered" name="properties" />
