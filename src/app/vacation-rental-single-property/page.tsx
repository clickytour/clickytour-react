...
export default function Page() {
  ...
  return (
    <PageShell>
      <Hero title="Vacation Properties" subtitle="Browse individual vacation rental properties with full details." ctaA="Search All" ctaB="Learn More" ctaHrefA="/search" ctaHrefB="/guests" />
