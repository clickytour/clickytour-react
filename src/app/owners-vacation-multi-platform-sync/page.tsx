...
import { OwnerMultiPlatformDiagram } from '@/components/diagrams';
    ...
    <PageShell>
      <section className="bg-gradient-to-r from-[#0F2B46] to-[#164E73] text-white py-16 md:py-20">
        <div className="container">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold mt-2">ClickyTour.com • Vacation Owners • Multi-Platform Sync</h1>
          <p className="max-w-3xl mt-4 text-cyan-100 text-lg">Distribute Your Property Across 30+ Channels — All in One Place</p>
        </div><div className="hidden lg:block max-w-sm"><OwnerMultiPlatformDiagram /></div></div></div>
      </section>
      
<section className="section"><div className="container"><SectionTitle title="ClickyTour.com • Vacation Owners • Multi-Platform Sync" /><FeatureGrid items={[
...
<section className="section section-soft"><div className="container"><SectionTitle title="Distribute Your Property Across 30+ Channels — All in One Place" /><CheckList items={[
