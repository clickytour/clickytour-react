...
const slug = 'owners-vacation-multi-platform-sync';
const fallbackTitle = 'Multi-Platform Sync for Owners';

export default async function OwnersVacationMultiPlatformSyncPage() {
