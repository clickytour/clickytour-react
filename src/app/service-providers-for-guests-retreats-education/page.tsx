...
const subtitle = "From yoga retreats to cultural workshops, ClickyTour connects your program with travelers seeking transformative experiences.";
const overview = [
  "From yoga retreats to cultural workshops, ClickyTour connects your program with travelers seeking transformative experiences.",
  "Select your program type for accurate targeting.",
  "Retreats & Education on ClickyTour",
  "Why Choose ClickyTour for Your Retreat or Course?"
];
const features = [
  "Yoga Retreats",
  "Wellness & Meditation Retreats",
  "Language Courses",
  "Art Workshops (Painting, Photography, Sculpture)",
  "Cooking Schools",
    ...
    <PageShell>
      <section className="bg-gradient-to-r from-[#0F2B46] to-[#164E73] text-white py-14 md:py-16">
        <div className="container">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold mt-2">Retreats & Education</h1>
