...
import { SPWhatYouOfferDiagram } from '@/components/diagrams';


const subtitle = "From tourism activities to essential property services — ClickyTour connects you to the right audience.";
const overview = [
  "From tourism activities to essential property services — ClickyTour connects you to the right audience.",
  "Rentals, real estate, and services in one system",
  "Send branded or no-logo quotes in 1 click",
  "Your Service Has a Place on ClickyTour"
];
const features = [
  ...
  "Found Your Category? Start Listing Today.",
  "Choose Your Plan",
    ...
    <PageShell>
      <section className="bg-gradient-to-r from-[#0F2B46] to-[#164E73] text-white py-14 md:py-16">
        <div className="container">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold mt-2">What You Can Offer</h1>
          <p className="text-cyan-100 mt-4 max-w-3xl">{subtitle}</p>
        </div>
            <div className="hidden lg:block max-w-sm"><SPWhatYouOfferDiagram /></div>
          </div>
        </div>
      </section>
