...
export const roleMenus: Record<'guests' | 'owners' | 'serviceProviders' | 'agents' | 'pmCompanies', MenuCategory[]> = {
  ...
  serviceProviders: [
    ...
    },
    {
      ...
      items: [
        { href: '/service-providers-for-guests-dining-nightlife/', label: 'Dining, Cafes & Nightlife' },
        ...
        { href: '/service-providers-for-guests-concierge-event/', label: 'Concierge & Event Services' },
        ...
        { href: '/service-providers-for-guests-attractions-family/', label: 'Attractions & Family Activities' },
        { href: '/service-providers-photo-viewpoint-tours/', label: 'Photo & Viewpoint Tours' },
        { href: '/service-providers-for-guests-medical-health/', label: 'Medical & Health Services' },
    ...
    },
    {
      ...
      items: [
        ...
        { href: '/service-providers-for-owners-checkin-checkout/', label: 'Check-In / Check-Out' },
  ...
  agents: [
    {
      ...
      items: [
        { href: '/agents-book-net-pricing/', label: 'Book Rentals & Services with Net Pricing' },
        { href: '/agents-vacation-property-pool/', label: 'Vacation Property Pool' },
        { href: '/agents-explore-services/', label: 'Explore Vacation Services / Businesses' },
        { href: '/agents-explore-activities/', label: 'Explore Activities' },
        { href: '/agents-explore-index/', label: 'Explore Main Index' },
        { href: '/agents-local-activities/', label: 'Agents Local Activities' },
      ],
    },
    {
      label: 'Real Estate',
      items: [
        ...
        { href: '/agents-real-estate-tools-sales/', label: 'Real Estate Sales Agent Tools' },
        { href: '/agents-list-properties/', label: 'List Properties on ClickyTour' },
    ...
    },
    {
      ...
      items: [
        ...
        { href: '/agents-tools-white-label-offers/', label: 'Create White-label Offers' },
        { href: '/agents-tools-branded-templates/', label: 'Branded Templates & Chat Tools' },
    ...
    },
    {
      label: 'Grow & Promote',
      items: [
        { href: '/agents-offer-no-branding/', label: 'Offer Listings Without Branding' },
        { href: '/agents-promote-local-services/', label: 'Promote Local Services' },
    ...
    },
    {
      label: 'Help & Support',
      items: [
        { href: '/agents-help-contact/', label: 'Contact & Support (agents)' },
        { href: '/agents-help-faq/', label: 'FAQ for Agents' },
        { href: '/agents-help-plans-pricing/', label: 'Agent Plans & Pricing' },
      ],
    },
  ],
  pmCompanies: [
    {
      ...
      items: [
        { href: '/management-promote-services/', label: 'Promote Your Services to Property Owners' },
        { href: '/management-match-properties/', label: 'Get Matched with New Properties' },
        { href: '/management-showcase-white-label/', label: 'Showcase Your Properties (White-label)' },
      ],
    },
    {
      label: 'Increase Bookings',
      items: [
        { href: '/management-vacation-property-pool/', label: 'Vacation Property Pool' },
        { href: '/management-list-properties/', label: 'List Your Properties' },
        { href: '/management-allow-agents-book/', label: 'Allow Agents to Book (Net Pricing)' },
      ],
    },
    {
      label: 'Manage & Operate',
      items: [
        { href: '/management-dashboard/', label: 'Manager Dashboard' },
        { href: '/management-channel-manager/', label: 'Channel Manager Integration' },
    ...
    },
    {
      label: 'Help & Support',
      items: [
        { href: '/management-help-faq/', label: 'FAQ for Managers' },
        { href: '/management-help-plans-pricing/', label: 'Manager Plans & Pricing' },
      ],
    },
  ],
};
