...
export default function AdvancedSearchDiagram() {
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
      ...
      <div className="space-y-3">
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="text-xs font-bold text-slate-800">🔍 Set Filters</p>
            <p className="text-[10px] text-slate-500 mt-0.5">Location, dates, type, price</p>
          </div>
        </div>
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="text-xs font-bold text-slate-800">📊 Refine Results</p>
            <p className="text-[10px] text-slate-500 mt-0.5">Sort and compare options</p>
          </div>
        </div>
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="text-xs font-bold text-slate-800">✅ Book or Inquire</p>
            <p className="text-[10px] text-slate-500 mt-0.5">Direct action from results</p>
          </div>
        </div>
      </div>
    </div>
