...
export default function MediaPartnersDiagram() {
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
      ...
      <div className="space-y-3">
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="text-xs font-bold text-slate-800">📰 Press & Media</p>
            <p className="text-[10px] text-slate-500 mt-0.5">Interviews, press kits, brand assets</p>
          </div>
        </div>
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="text-xs font-bold text-slate-800">🤝 Strategic Partners</p>
            <p className="text-[10px] text-slate-500 mt-0.5">Technology and distribution</p>
          </div>
        </div>
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="text-xs font-bold text-slate-800">💰 Affiliate Program</p>
            <p className="text-[10px] text-slate-500 mt-0.5">Earn commissions by referring</p>
          </div>
        </div>
      </div>
    </div>
