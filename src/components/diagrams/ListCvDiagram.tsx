export function ListCvDiagram() {
  return (
    <svg viewBox="0 0 320 280" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
      ...
      <text x="160" y="33" textAnchor="middle" className="fill-white text-[13px] font-bold">Submit Your CV</text>
      ...
      <text x="88" y="96" className="fill-slate-700 text-[11px] font-medium">Personal Details</text>
      ...
      <text x="88" y="164" className="fill-slate-700 text-[11px] font-medium">Experience</text>
      ...
      <text x="88" y="232" className="fill-slate-700 text-[11px] font-semibold">Upload & Submit</text>
