...
export default function GuestServiceFormDiagram() {
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
      ...
      <div className="space-y-3">
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="text-xs font-bold text-slate-800">🔍 Choose Service</p>
            <p className="text-[10px] text-slate-500 mt-0.5">Cleaning, transport, tours, etc.</p>
          </div>
        </div>
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="text-xs font-bold text-slate-800">📍 Location & Date</p>
            <p className="text-[10px] text-slate-500 mt-0.5">Where and when you need it</p>
          </div>
        </div>
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="text-xs font-bold text-slate-800">✉️ Submit Request</p>
            <p className="text-[10px] text-slate-500 mt-0.5">Matched with local providers</p>
          </div>
        </div>
      </div>
    </div>
