export function JobSeekerDashboardDiagram() {
  return (
    <svg viewBox="0 0 320 280" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
      ...
      <text x="160" y="33" textAnchor="middle" fill="white" fontSize="13" fontWeight="bold">Job Seeker Dashboard</text>
      ...
      <text x="88" y="96" fill="#334155" fontSize="11" fontWeight="500">Active Applications</text>
      ...
      <text x="88" y="164" fill="#334155" fontSize="11" fontWeight="500">Messages</text>
      ...
      <text x="88" y="232" fill="#334155" fontSize="11" fontWeight="600">Profile Stats</text>
