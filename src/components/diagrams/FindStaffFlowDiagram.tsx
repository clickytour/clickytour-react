...
export default function FindStaffFlowDiagram() {
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
      ...
      <div className="space-y-3">
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="text-xs font-bold text-slate-800">📝 Post a Request</p>
            <p className="text-[10px] text-slate-500 mt-0.5">Describe the role, location, and dates</p>
          </div>
        </div>
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="text-xs font-bold text-slate-800">🔍 Get Matched</p>
            <p className="text-[10px] text-slate-500 mt-0.5">Candidates matched by skill and location</p>
          </div>
        </div>
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="text-xs font-bold text-slate-800">📋 Review & Interview</p>
            <p className="text-[10px] text-slate-500 mt-0.5">Browse profiles and shortlist</p>
          </div>
        </div>
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="text-xs font-bold text-slate-800">✅ Hire</p>
            <p className="text-[10px] text-slate-500 mt-0.5">Onboard your new team member</p>
          </div>
        </div>
      </div>
    </div>
