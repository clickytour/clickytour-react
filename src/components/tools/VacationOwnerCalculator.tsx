...
const MANAGEMENT_MODELS = [
  ...
  { id: "partial", label: "Partial Management (ClickyTour)", fee: 15, desc: "Multi-platform sync, calendar management, guest comms. You handle on-site ops" },
  { id: "full-clickytour", label: "Full Management (ClickyTour)", fee: 20, desc: "End-to-end: listing, pricing, guest comms, cleaning coordination, reporting" },
...
export default function VacationOwnerCalculator() {
  ...
  const [managementIdx, setManagementIdx] = useState(2); // full clickytour
      ...
      <div className="rounded-2xl bg-gradient-to-r from-cyan-700 to-blue-800 p-5 text-white">
        <div className="flex flex-col md:flex-row md:items-center gap-4">
          <div className="flex-1">
            <h4 className="text-lg font-bold">Maximize Your Returns with ClickyTour</h4>
            <p className="text-sm text-cyan-100 mt-1">
              ClickyTour offers flexible management from 0% (self-managed with tools) to 20% (full management).
          ...
          <div className="flex flex-col gap-2">
            <Link href="/owners-vacation" className="rounded-lg bg-white px-5 py-2.5 text-sm font-bold text-cyan-700 text-center hover:bg-cyan-50">
              Explore Owner Options
            </Link>
            <Link href="/owners-vacation-free-evaluation" className="rounded-lg border border-white/40 px-5 py-2 text-xs font-medium text-white text-center hover:bg-white/10">
